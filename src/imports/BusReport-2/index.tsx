import svgPaths from "./svg-luquq8gyq9";
...
export default function BusReport() {
  return (
    <div className="bg-white relative size-full" data-name="Bus report">
      ...
      <div className="absolute bg-white content-stretch drop-shadow-[0px_4px_4px_rgba(0,0,0,0.15),0px_1px_1.5px_rgba(0,0,0,0.3)] flex items-center justify-center left-[330px] px-[8px] py-[12px] rounded-[32px] size-[50px] top-[781px]" data-name="aibox">
        <ContentStandard />
      </div>
    </div>
  );
