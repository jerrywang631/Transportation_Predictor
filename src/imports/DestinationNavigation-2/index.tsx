import svgPaths from "./svg-9p25cdwakk";
...
function EndNavigation() {
  return (
    <button className="absolute contents cursor-pointer left-[31px] top-[413px]" data-name="end navigation">
      <div className="absolute left-[31px] size-[30px] top-[413px]">
      ...
      <div className="absolute left-[37px] overflow-clip size-[18px] top-[419px]" data-name="close">
...
function Group() {
  return (
    <div className="absolute contents left-[214.09px] top-[413px]">
      <div className="absolute bg-white h-[30px] left-[214.09px] rounded-[10px] top-[413px] w-[149.914px]" />
      <p className="[word-break:break-word] absolute font-['SF_Pro:Regular',sans-serif] font-normal leading-[22px] left-[225px] text-[#585858] text-[13px] top-[417px] tracking-[-0.08px] w-[140.207px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        switch to stop search
      </p>
    </div>
  );
}
...
export default function DestinationNavigation() {
  return (
    <div className="bg-white relative size-full" data-name="Destination navigation">
      ...
      <div className="absolute bg-[#d9d9d9] h-[416px] left-[19px] rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[402px] w-[355px]" data-name="background" />
      ...
      <EndNavigation />
      <Group />
      <div className="absolute bg-white content-stretch drop-shadow-[0px_4px_4px_rgba(0,0,0,0.15),0px_1px_1.5px_rgba(0,0,0,0.3)] flex items-center justify-center left-[325px] px-[8px] py-[12px] rounded-[32px] size-[50px] top-[345px]" data-name="aibox">
        <ContentStandard />
      </div>
    </div>
  );
